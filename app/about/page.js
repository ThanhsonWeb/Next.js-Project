...
export default async function Page() {
	...
	return (
		<div className="grid grid-cols-5 gap-x-20 gap-y-32 text-lg items-center">
			<div className="col-span-3">
				...
				<div className="space-y-8">
					...
					<p>
						Our {cabins?.length ?? 0} luxurys cabins provide a cozy base, but the
						real freedom and peace youll find in the surrounding mountains.
			...
			{/* in case We can't do like image1 */}
			{/* 1. wrap image by container */}
